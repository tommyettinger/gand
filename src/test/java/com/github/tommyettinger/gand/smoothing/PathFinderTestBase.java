...
public abstract class PathFinderTestBase {
	protected PathFinderDemos container;
	public String testName;
	protected InputProcessor inputProcessor;
	protected CollapsableWindow detailWindow;

	public PathFinderTestBase (PathFinderDemos container, String name) {
		this(container, name, null);
	}

	public PathFinderTestBase (PathFinderDemos container, String testName, InputProcessor inputProcessor) {
