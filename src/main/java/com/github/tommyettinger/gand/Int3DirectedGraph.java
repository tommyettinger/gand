...
public class Int3DirectedGraph extends DirectedGraph<PointI3> implements Json.Serializable {
    ...
    public Int3DirectedGraph() {
        super();
    }

    public Int3DirectedGraph(Collection<PointI3> vertices) {
        this(vertices, Collections.emptyList(), 1f);
    }

    public Int3DirectedGraph(Collection<PointI3> vertices, Collection<Edge<PointI3>> edges, float defaultEdgeWeight) {
        super();
    ...
    public Int3DirectedGraph(Graph<PointI3> graph) {
        super();
     ...
     */
    public Int3DirectedGraph(boolean[][][] validGrid, float defaultEdgeWeight){
        super();
     ...
     * @param defaultEdgeWeight the default edge weight to use when a weight is unspecified
     */
    public Int3DirectedGraph(char[][][] validGrid, char validChar, float defaultEdgeWeight){
        super();
        setDefaultEdgeWeight(defaultEdgeWeight);
        for (int z = 0; z < validGrid.length; z++) {
            for (int y = 0; y < validGrid[z].length; y++) {
     ...
     * @param defaultEdgeWeight the default edge weight to use when a weight is unspecified
     */
    public Int3DirectedGraph(float[][][] validGrid, float minimumThreshold, float maximumThreshold, float defaultEdgeWeight){
        super();
        setDefaultEdgeWeight(defaultEdgeWeight);
        for (int z = 0; z < validGrid.length; z++) {
            for (int y = 0; y < validGrid[z].length; y++) {
    ...
    @Override
    public Int3DirectedGraph createNew() {
        return new Int3DirectedGraph();
    }
