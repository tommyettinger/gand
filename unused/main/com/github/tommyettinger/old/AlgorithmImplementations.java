...
import com.github.tommyettinger.old.ds.BinaryHeap;
import com.github.tommyettinger.old.ds.ObjectDeque;
import com.github.tommyettinger.old.ds.ObjectList;
import com.github.tommyettinger.old.ds.ObjectSet;
...
class AlgorithmImplementations<V> {
    ...
    final Comparator<Connection<V>> weightComparator = (o1, o2) -> NumberUtils.floatToIntBits(o1.weight - o2.weight);

    final Comparator<Connection<V>> reverseWeightComparator = (o1, o2) -> NumberUtils.floatToIntBits(o2.weight - o1.weight);
