 ...
 */
public class IntDeque extends IntList implements IntCollection, Json.Serializable {
	/**
	...
	public IntDeque(IntList other, int offset, int count) {
		this(count);
	...
	public boolean addAll (IntIterator it) {
	...
	/**
	 * An alias for {@link #addAll(IntCollection)}, this adds every item in {@code c} to this in order at the end.
	 * @param c the elements to be inserted into this deque
	 * @return {@code true} if this deque changed as a result of the call
	 */
	public boolean addAllLast (IntCollection c) {
		return addAll(c);
	}
	 ...
	 * @return {@code true} if this deque changed as a result of the call
	 */
	public boolean addAllFirst (IntCollection c) {
		final int cs = c.size();
		if(cs == 0) return false;
		int oldSize = size;
		ensureCapacity(Math.max(cs, oldSize));
	...
	/**
	 * An alias for {@link #addAll(int, IntCollection)}; inserts all elements
	 ...
	 */
	public boolean insertAll(int index, IntCollection c) {
	...
	/**
	 * Exactly like {@link #addAll(IntCollection)}, but takes an array instead of a IntCollection.
	...
	/**
	 * Exactly like {@link #addAllFirst(IntCollection)}, but takes an array instead of a IntCollection.
	 * @see #addAllFirst(IntCollection)
	 * @param array the elements to be inserted into this deque
	 * @return {@code true} if this deque changed as a result of the call
	 */
	...
	/**
	 * Like {@link #addAll(int, IntCollection)}, but takes an array instead of a IntCollection and inserts it
	...
	/**
	 * Like {@link #addAll(int, IntCollection)}, but takes an array instead of a IntCollection, gets items starting at
	...
	/**
	 * Exactly like {@link #addAll(IntCollection)}, but takes an IntList instead of a IntCollection.
	 * @see #addAll(IntCollection)
	 * @param ord the elements to be inserted into this deque
	 * @return {@code true} if this deque changed as a result of the call
	 */
	public boolean addAll (IntList ord) {
	 ...
	 * @return {@code true} if this deque changed as a result of the call
	 */
	public boolean addAll (IntList ord, int offset, int length) {
		return addAll(size, ord, offset, length);
	}

	/**
	 * Like {@link #addAll(int, IntCollection)}, but takes an ord instead of a IntCollection and inserts it
	 * so the first item will be at the given {@code index}.
	 ...
	 * @return {@code true} if this deque changed as a result of the call
	 */
	public boolean addAll(int index, IntList ord) {
	 ...
	 * @return {@code true} if this deque changed as a result of the call
	 */
	public boolean addAll (int index, IntList ord, int offset, int length) {
		final int cs = Math.min(ord.size() - offset, length);
		if(cs <= 0) return false;
		int place = ensureGap(index, cs);
		for (int i = offset, n = offset + cs; i < n; i++) {
			items[place++] = ord.get(i);
	...
	/**
	 * An alias for {@link #addAll(IntList)}.
	 * @see #addAll(IntList)
	 * @param ord the elements to be inserted into this deque
	 * @return {@code true} if this deque changed as a result of the call
	 */
	public boolean addAllLast (IntList ord) {
		return addAll(size, ord, 0, ord.size());
	}

	/**
	 * An alias for {@link #addAll(IntList, int, int)}.
	 * @see #addAll(IntList, int, int)
	 * @param ord the elements to be inserted into this deque
	 * @param offset the index of the first item in ord to add
	 * @param length how many items, at most, to add from ord into this
	 * @return {@code true} if this deque changed as a result of the call
	 */
	public boolean addAllLast (IntList ord, int offset, int length) {
		return addAll(size, ord, offset, length);
	}

	/**
	 * Exactly like {@link #addAllFirst(IntCollection)}, but takes an ord instead of a IntCollection.
	 * @see #addAllFirst(IntCollection)
	 * @param ord the elements to be inserted into this deque
	 * @return {@code true} if this deque changed as a result of the call
	 */
	public boolean addAllFirst (IntList ord) {
		return addAll(0, ord, 0, ord.size());
	}

	/**
	 * Like {@link #addAllFirst(IntList)}, but only uses at most {@code length} items from {@code ord}, starting at
	 * {@code offset}. The order of {@code ord} will be preserved, starting at the head of the deque.
	 * @see #addAllFirst(IntList)
	 * @param ord the elements to be inserted into this deque
	 * @param offset the index of the first item in ord to add
	 * @param length how many items, at most, to add from ord into this
	 * @return {@code true} if this deque changed as a result of the call
	 */
	public boolean addAllFirst (IntList ord, int offset, int length) {
		return addAll(0, ord, offset, length);
	}

	/**
	 * Alias for {@link #addAll(int, IntList)}.
	 * @param index the index in this deque's iteration order to place the first item in {@code ord}
	 * @param ord the elements to be inserted into this deque
	 * @return {@code true} if this deque changed as a result of the call
	 */
	public boolean insertAll(int index, IntList ord) {
		return addAll(index, ord, 0, ord.size());
	}

	/**
	 * Alias for {@link #addAll(int, IntList, int, int)}.
	 * @param index the index in this deque's iteration order to place the first item in {@code ord}
	 * @param ord the elements to be inserted into this deque
	 * @param offset the index of the first item in ord to add
	 * @param length how many items, at most, to add from ord into this
	 * @return {@code true} if this deque changed as a result of the call
	 */
	public boolean insertAll(int index, IntList ord, int offset, int length) {
	...
	boolean containsAll (IntIterator it) {
		while (it.hasNext()) {
	...
	public boolean containsAll (int[] array, int offset, int length) {
	...
	public boolean containsAny (IntCollection other) {
		return containsAny(other.iterator());
	}

	public boolean containsAny (IntIterator it) {
		while (it.hasNext()) {
	...
	public boolean containsAny (int[] array) {
		return containsAny(array, 0, array.length);
	}

	public boolean containsAny (int[] array, int offset, int length) {
		for (int i = offset, n = 0; n < length && i < array.length; i++, n++) {
	 ...
	 * @return true if this collection was modified.
	 */
	public boolean removeAll (IntIterator it) {
		IntIterator me;
	...
	public boolean removeAll (int[] array, int offset, int length) {
		IntIterator me;
		int originalSize = size();
		for (int i = offset, n = 0; n < length && i < array.length; i++, n++) {
			int item = array[i];
	 ...
	 * @return true if this collection was modified.
	 */
	public boolean removeEach (IntCollection other) {
	 ...
	 * @return true if this collection was modified.
	 */
	public boolean removeEach (IntIterator it) {
		boolean changed = false;
		while (it.hasNext()) {
	...
	public boolean removeEach (int[] array) {
		return removeEach(array, 0, array.length);
	}

	public boolean removeEach (int[] array, int offset, int length) {
		boolean changed = false;
		for (int i = offset, n = 0; n < length && i < array.length; i++, n++) {
	 ...
	 * @return a new String representing this PrimitiveCollection
	 */
	public String toString (String entrySeparator, boolean brackets) {
		return appendTo(new StringBuilder(32), entrySeparator, brackets).toString();
	}

	/**
	 * Appends to a StringBuilder from the contents of this PrimitiveCollection, using {@link StringBuilder#append(int)}
	 * to append int items.
	 *
	 ...
	 * This uses the {@link IntCollection#iterator()} of both this and {@code o},
