...
package com.github.tommyettinger.old.ds;

import com.github.tommyettinger.old.function.ObjectComparators;

import java.util.*;

/**
 * A resizable, insertion-ordered list of {@code T} items, typically objects (they can also be arrays).
 * This is a thin wrapper around {@link ArrayList} to do some of
...
public class ObjectList<T> extends ArrayList<T> {
	 ...
	 */
	public ObjectList(List<T> other, int offset, int count) {
		super(count);
	 ...
	 */
	public void add(T value0, T value1) {
		add(value0);
		add(value1);
	}
	 ...
	 */
	public void add(T value0, T value1, T value2) {
		add(value0);
		add(value1);
		add(value2);
	}
	 ...
	 */
	public void add(T value0, T value1, T value2, T value3) {
		add(value0);
		add(value1);
		add(value2);
		add(value3);
	 ...
	 * @return true if this is modified by this call, as {@link #addAll(Collection)} does
	 */
	public boolean addAll (List<T> other, int offset, int count) {
	 ...
	 * @return true if this is modified by this call, as {@link #addAll(Collection)} does
	 */
	public boolean addAll (int insertionIndex, List<T> other, int offset, int count) {
		boolean changed = false;
	 ...
	 * non-negative). The behavior here matches the libGDX Array classes.
	 *
