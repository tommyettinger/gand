...
//	};
	...
	private static float defaultLoadFactor = 0.5f;
	 ...
	 * {@code 0.000001f}, but it should never actually be that low) and less than or
	 * equal to 1. The initial value for the default load factor is 0.5.
	 * <br>
	...
	public static void setDefaultLoadFactor (float loadFactor) {
		defaultLoadFactor = Math.min(Math.max(loadFactor, 0.000001f), 1f);
	}
