...
//		shift = Long.numberOfLeadingZeros(mask);
	...
	public static class ObjectSetIterator<T> implements Iterable<T>, Iterator<T> {
		 ...
		 * Does not change the position of this iterator. Internally, this simply creates an ArrayList, passes it to
		 * {@link #appendInto(Collection)}, and returns that ArrayList.
		 */
